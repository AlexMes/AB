        ...
        <div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    ...
                    @enderror
                    <form action="{{ route('crm.authenticate') }}" method="POST">
                        @csrf
                        <div>
                    ...
                    <div class="mt-6">
                        ...
                        <div class="mt-6 flex justify-center items-center">
                            <a href="{{ route('crm.auth.redirect', $tenant) }}"
                               class="w-full flex justify-center py-2 px-4 border text-sm font-medium rounded-md text-gray-700 bg-white hover:text-white hover:bg-green-600 focus:outline-none focus:border-green-700 focus:shadow-outline-green active:bg-green-700 transition duration-50 ease-in-out">TCRM</a>
                        </div>
                    </div>
                    @endif
                </div>

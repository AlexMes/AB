    ...
    <div class="mt-8">
        <div class="flex flex-col">
            <div class="container mx-auto">
                <div class="bg-white shadow px-4 py-5 border-b border-gray-200 sm:px-6 w-full">
                    <h3 class="text-lg leading-6 font-medium text-gray-900">
                        @lang('crm::label.creation')
                    </h3>
                    <form method="POST"
                          action="{{ route('crm.labels.store') }}">
                        @csrf
                        <div
                            ...
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                <div class="max-w-lg rounded-md shadow-sm">
                                    <input id="name"
                                           ...
                                           placeholder="@lang('crm::label.form_name_ph')"/>

@extends('crm::app')
@section('title', __('crm::common.office_report'))
@section('content')
    <div class="max-w-full mt-6" x-data="OfficeStatistics()" x-init="init()">
        <div class="flex flex-col">
            <form action="{{ route('crm.office-statistic') }}" class="flex flex-col flex-no-wrap items-center mb-6 md:flex-wrap md:flex-row">
                        ...
                        <tr>
                            <th class="px-3 py-3 text-xs font-medium leading-4 text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                                @component('crm::components.sort', [
                                    'header'     => trans('crm::report.office'),
                                    'key'        => 'name',
                                    'defaultKey' => 'name',
                                ]) @endcomponent
                            </th>

@extends('crm::app')
@section('title', __('crm::common.statistics'))
@section('content')
    <div class="max-w-full mt-6" x-data="Statistics()" x-init="init()">
        <div class="flex flex-col">
            <form action="{{ route('crm.statistic') }}" class="flex flex-col flex-no-wrap items-center mb-6 md:flex-row md:flex-wrap">
            ...
            <div class="py-2 -my-2 overflow-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                <div
                    class="inline-block min-w-full overflow-y-hidden align-middle border-b border-gray-200 shadow sm:rounded-lg">
                    <table class="min-w-full">
                        ...
                        <tr>
                            ...
                            {{-- <th class="px-3 py-2 text-xs font-medium leading-4 text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                                @lang('crm::report.ordered')
                            </th> --}}
                            <th class="px-3 py-2 text-xs font-medium leading-4 text-left text-gray-500 uppercase border-b border-gray-200 bg-gray-50">
                                @lang('crm::report.leads')
                            </th>
                            <th class="px-4 py-3 text-xs font-medium leading-4 text-left text-gray-500 uppercase whitespace-no-wrap border-b border-gray-200 bg-gray-50">
                                @lang('crm::report.clean_leads')
                            </th>
                        ...
                        @foreach($statistics as $statistic)
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="py-2 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200 pxsemibold3">
                                    <span sm="font-bold"> {{ $statistic->conversion }} </span> &nbsp;%
                                </td>
                                <td class="px-3 py-2 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">

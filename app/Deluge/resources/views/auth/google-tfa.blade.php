        ...
        <div class="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                    ...
                    @enderror
                    <form action="{{ route('google-tfa.login') }}" method="POST">
                        @csrf
                        <div>
                            <label for="one_time_password" class="block text-sm font-medium leading-5 text-gray-700">
                                One Time Password
                            </label>
                            <div class="mt-1 rounded-md shadow-sm">
                                <input id="one_time_password" name="one_time_password" placeholder="112233" type="number" required

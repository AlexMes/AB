...
@section('content')
    ...
    <div x-data="CampaignsForm()" x-init="init()" class="bg-white shadow overflow-visible sm:rounded-md mt-8 max-w-7xl mx-auto">
        ...
        <form method="post" action="{{ route('deluge.campaigns.update', $campaign) }}" class="px-6">
            @method('PUT')
            @csrf
            <div
                ...
                <div class="-my-2 sm:col-span-2">
                    <div class="max-w-xs">
                        @component('deluge::components.multiselect', [
                                ...
                                'label' => 'name',
                                'multiple' => false,
                                'selected' => old('account_id', $campaign->account_id),
                            ]) @endcomponent
                    </div>
                ...
                <div class="-my-2 sm:col-span-2">
                    <div class="max-w-xs">
                        @component('deluge::components.multiselect', [
                                ...
                                'label' => 'name',
                                'multiple' => false,
                                'selected' => old('bundle_id', $campaign->bundle_id),
                            ]) @endcomponent
                    </div>

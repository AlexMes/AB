                ...
                <table class="min-w-full">
                    ...
                    @foreach($campaigns as $campaign)
                        <tr class="cursor-pointer hover:bg-gray-100"
                            onclick="window.location = '{{ route('deluge.campaigns.insights.index', $campaign->id) }}'">
                ...
                <nav class="flex items-center justify-between px-4 py-3 bg-white border-gray-200 sm:px-6">
                    ...
                    <div class="flex justify-between flex-1 sm:justify-end">
                        @if($campaigns->previousPageUrl())
                            <a href="{{ $campaigns->appends(request(['bundle']))->previousPageUrl() }}"
                        ...
                        @if($campaigns->nextPageUrl())
                            <a href="{{ $campaigns->appends(request(['bundle']))->nextPageUrl() }}"

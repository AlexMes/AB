    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg mt-8 max-w-7xl mx-auto">
        <div class="px-4 py-5 border-b border-gray-200 flex justify-between items-center sm:px-6">
            <h3 class="text-lg leading-6 font-medium text-gray-900">
                {{ sprintf('[#%d] *%s', $creditCard->id, $creditCard->digits) }}
            </h3>

            <div>
                @can('update', $creditCard)
                    <a href="{{ route('deluge.credit-cards.edit', $creditCard) }}"
            ...
            <dl>
                <div
                    ...
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                        <span class="inline-block">{{ $creditCard->bank_name }}</span>
                    </dd>
                </div>
                <div
                    ...
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                        <span class="inline-block">*{{ $creditCard->digits }}</span>
                    </dd>
                </div>
                <div
                    class="mt-8 sm:mt-0 sm:grid sm:grid-cols-3 sm:gap-4 sm:border-t sm:border-gray-200 sm:px-6 sm:py-5">
                    ...
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                        <div class="font-semibold">{{ $creditCard->account->name }}</div>

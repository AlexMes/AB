@extends('deluge::app')
@section('title', 'Account stats report')
@section('content')
    <div class="max-w-full mt-6" x-data="AccountStatsReport()" x-init="init()">
        <div class="flex flex-col">
            <form action="{{ route('deluge.reports.account-stats') }}" class="flex flex-col mb-6">
                <div class="flex items-center">
                    ...
                    @if (auth()->user()->isAdmin() || auth()->user()->isTeamLead() || auth()->id() === 132)
                        <div class="w-1/5 mr-4 sm:col-span-3">

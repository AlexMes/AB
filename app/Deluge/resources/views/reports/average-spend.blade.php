@extends('deluge::app')
@section('title', 'Средний спенд')
@section('content')
<div class="max-w-full mt-6" x-data="AverageSpendReport()" x-init="init()">
    <div class="flex flex-col">
        <form action="{{ route('deluge.reports.average-spend') }}" class="flex flex-col mb-6">
            ...
            <div class="flex items-center">
                ...
                @endif
                <div class="w-1/5 mr-4 sm:col-span-3">
                    <label for="suppliers" class="relative block text-sm font-medium leading-5 text-gray-700 top-2">
                        Поставщик
                    </label>
                    <div class="mt-1">
                        @component('deluge::components.multiselect', [

@extends('deluge::app')
@section('title', 'Косты байеров')
@section('content')
    <div class="max-w-full mt-6" x-data="BuyerCostsReport()" x-init="init()">
        <div class="flex flex-col">
            <form action="{{ route('deluge.reports.buyer-costs') }}" class="flex flex-col mb-6">
                        ...
                        <x-deluge::btn-dropdown>
                            ...
                            <x-slot name="options">
                                @if(auth()->user()->isAdmin() || auth()->id() === 132)
                                    <a href="{{ route('deluge.reports.exports.buyer-costs', request()->all()) }}"
                                       target="_blank"

@extends('deluge::app')
@section('title', 'Buyer stats report')
@section('content')
    <div class="max-w-full mt-6" x-data="BuyerStatsReport()" x-init="init()">
        <div class="flex flex-col">
            <form action="{{ route('deluge.reports.buyer-stats') }}" class="flex flex-col mb-6">
                ...
                <div class="flex items-center">
                    ...
                    @endif
                    @unless(auth()->user()->isBuyer() && count($teams) > 1)
                        <div class="w-1/5 mr-4 sm:col-span-3">
                    ...
                    <div class="w-1/5 mr-4 sm:col-span-3">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <select id="part"
                                ...
                                @foreach(\App\Deluge\Reports\BuyerStats\Report::PARTS as $part)

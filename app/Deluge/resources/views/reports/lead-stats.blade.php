@extends('deluge::app')
@section('title', 'Статистика лидов')
@section('content')
    <div class="max-w-full mt-6" x-data="LeadStatsReport()" x-init="init()">
        <div class="flex flex-col">
            <form action="{{ route('deluge.reports.lead-stats') }}" class="flex flex-col mb-6">
                    ...
                    <div class="w-1/5 mr-4 sm:col-span-3">
                        ...
                        <div class="mt-1 rounded-md shadow-sm">
                            <select id="level"
                                ...
                                <option value="utm_content" @if(request('level', 'utm_content') === 'utm_content') selected @endif>Контент</option>
                                <option value="utm_campaign" @if(request('level') === 'utm_campaign') selected @endif>Кампания</option>
                            </select>
                        </div>
                    </div>
                    <div class="w-1/5 mr-4 sm:col-span-3">
                ...
                <div class="flex items-center">
                    <div class="w-1/5 mr-4 sm:col-span-3">
                        <label for="offices" class="relative block text-sm font-medium leading-5 text-gray-700 top-2">
                            Офис
                        </label>
                        <div class="mt-1">
                            @component('deluge::components.multiselect', [
                    ...
                    @endif
                    <div class="w-1/5 mr-4 sm:col-span-3">
                        <label for="officeGroups" class="relative block text-sm font-medium leading-5 text-gray-700 top-2">
                            Группа офиса
                        </label>
                        <div class="mt-1">
                            @component('deluge::components.multiselect', [

...
@section('content')
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg mt-8 max-w-7xl mx-auto">
        <div class="px-4 py-5 border-b border-gray-200 flex justify-between items-center sm:px-6">
            ...
            <div>
                @can('update', $trafficSource)
                    <a href="{{ route('deluge.traffic-sources.edit', $trafficSource) }}"
            ...
            <dl>
                <div
                    ...
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                        <span class="inline-block">{{ $trafficSource->name }}</span>
                    </dd>
                </div>
                <div
                    ...
                    <dd class="mt-1 text-sm leading-5 text-gray-900 sm:mt-0 sm:col-span-2">
                        {{ $trafficSource->created_at->format('M d, H:i:s') }}
                    </dd>
                </div>
            </dl>
        </div>

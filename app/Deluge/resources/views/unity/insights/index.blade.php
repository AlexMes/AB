...
@section('content')
    <div x-data="UnityInsightsIndex()" x-init="init()" class="mt-8">
        <div class="flex flex-col">
            ...
            @endif
            <form action="{{ route('deluge.unity.insights.index') }}" class="flex flex-col items-center mb-6 md:flex-row">
                <div class="w-1/6 mr-4 md:w-1/5 sm:col-span-3">
                    <label for="app" class="relative block text-sm font-medium leading-5 text-gray-700 top-2">
                        Приложение
                    </label>
                    <div class="mt-1">
                ...
                <div class="w-1/6 mr-4 md:w-1/5 sm:col-span-3">
                    <label for="campaign" class="relative block text-sm font-medium leading-5 text-gray-700 top-2">
                        Кампания
                    </label>
                    <div class="mt-1">
                        @component('deluge::components.multiselect', [
                ...
                <div class="w-1/6 mr-4 md:w-1/5 sm:col-span-3">
                    <label for="organization" class="relative block text-sm font-medium leading-5 text-gray-700 top-2">
                        Организация
                    </label>
                    <div class="mt-1">
                        @component('deluge::components.multiselect', [
                ...
                <div class=" mt-5 sm:col-span-3">
                    <span class="inline-flex rounded-md shadow-sm">
                      <a href="{{ route('deluge.unity.insights.create') }}"
                              class="inline-flex items-center px-3 py-2 -mb-px text-sm font-medium leading-4 text-white transition duration-150 ease-in-out bg-indigo-600 border border-transparent rounded-md hover:bg-indigo-500 focus:outline-none focus:border-indigo-700 focus:shadow-outline-indigo active:bg-indigo-700">
            ...
            @include('deluge::unity.insights.index-data')
        </div>
    </div>
@endsection

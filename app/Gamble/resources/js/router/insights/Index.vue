...
export default {
  name: 'insights-index',
  components: {InsightListItem, Pagination},
  data: () => {
    return {
      insights: [],
      response: {},
  ...
  methods: {
    load(page = 1) {
      axios.get('/api/insights', {
        ...
        .then(r => {
          this.insights = r.data.data;
          this.response = r.data;
        })
        .catch(err => this.$toast.error({title: 'Unable load insights.', message: err.response.data.message}));
    },
  },
};
</script>

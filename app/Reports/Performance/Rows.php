...
class Rows implements Arrayable
{
     ...
     * @param mixed $manualInsights
     *
     * @return \App\Reports\Performance\Rows
     */
    public static function build(
        ...
        return new static($insights, $manualInsights, $deposits, $level, $traffic, $hideFacebook);
    }
    ...
    protected function conversions($group, $name)
    {
        if ($this->level === Report::LEVEL_CAMPAIGN) {
            return [
                ...
                Fields::MANUAL_LEADS          => LeadsCount::make($this->manualInsights->whereStrict('name', $name))->metric(),

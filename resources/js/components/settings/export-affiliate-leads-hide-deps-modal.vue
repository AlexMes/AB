<template>
  <modal
    name="export-affiliate-leads-hide-deps-modal"
    height="auto"
    :adaptive="true"
    ...
    <div class="flex flex-col w-full p-6">
      ...
      <div class="flex w-full">
        ...
        <button
          ...
          @click="$modal.hide('export-affiliate-leads-hide-deps-modal')"
        >
          Отмена
        </button>
      </div>
...
export default {
  ...
  methods: {
    ...
    download() {
      this.isBusy = true;
      axios
        .get(`/api/affiliates/${this.affiliate.id}/export-leads-hide-deps`, {
        ...
        .then(response => {
          ...
          this.$modal.hide('export-affiliate-leads-hide-deps-modal');
          this.date = null;

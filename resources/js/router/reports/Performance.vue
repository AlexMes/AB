        ...
        <div class="container flex flex-col mx-auto">
            ...
            <div class="flex flex-col my-6">
                ...
                >
                    ...
                    <!--          <div class="flex flex-col w-full mx-2 my-2 align-middle md:my-0 ">-->
                    <!--            <label v-if="hideFacebook">Скрыть FB</label>-->
                    <!--            <label v-else>Показывать FB</label>-->
                    <!--            <toggle-->
                    <!--              v-model="hideFacebook"-->
                    <!--              class="mt-2"-->
                    <!--            ></toggle>-->
                    <!--          </div>-->
                    <div
                ...
                <div class="flex items-start md:items-center">
                    ...
                    <div class="flex flex-col w-1/12 my-2 ml-2 align-middle">
                        <label class="mb-2">Разделить</label>
                        <select v-model="part">
                            <option
                                v-for="part in filterSets.parts"
                                :key="part.id"
                                :value="part.id"
                                v-text="part.name"
                            ></option>
                            ...
                            <template slot="option" slot-scope="props">
                                <div>
                                    ...
                                    <div class="mt-1 text-xs">
                                        <span v-if="props.option.sp"
                                            >{{ props.option.sp.name }}
                                        </span>
                                        <span v-if="props.option.bp"
                                            >{{ props.option.bp.name }}
                                        </span>
                                        <span v-if="props.option.binom_id"
                                            >{{ props.option.binom_id }}
                                        </span>
                                    </div>
                                </div>
                            </template>
...
export default {
    ...
    methods: {
        load() {
            this.isBusy = true;
            axios
                .get("/api/reports/performance", { params: this.cleanFilters })
        ...
        download() {
            this.isBusy = true;
            axios
                .get("/api/reports/exports/performance", {

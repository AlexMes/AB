...
class StartCallTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function itCreatesCallbackOnSuccess()
    {
        ...
        $this->get(route('crm.assignment.call', $assignment));

        $this->assertCount(1, $assignment->callbacks);
        $this->assertEquals($assignment->lead->formatted_phone, $assignment->callbacks->first()->phone);
